...
add_action( 'admin_menu', 'srb_add_admin_menu' );

/**
 * Settings page content
 */
function srb_settings_page() {
	...
	if ( isset( $_GET['settings-updated'] ) ) {
		add_settings_error( 'srb_messages', 'srb_message', __( 'Settings Saved', 'simple-reviews-badge' ), 'updated' );
	}

	// Display messages.
	settings_errors( 'srb_messages' );
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'Simple Reviews Badge Settings', 'simple-reviews-badge' ); ?></h1>
			<form method="post" action="options.php">
				<?php
				settings_fields( 'srb_options_group' ); // Security: nonce for form submission.
				do_settings_sections( 'srb_options_group' );
				?>
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td>
							<input type="text" name="srb_place_id" value="<?php echo esc_attr( srb_get_option( 'srb_place_id' ) ); ?>" placeholder="e.g., ChIJuQkUQ5YqdEgRipQ_lAyte_Y" required />
					...
					<tr valign="top">
						...
						<td>
							<input type="text" name="srb_api_key" value="<?php echo esc_attr( srb_get_option( 'srb_api_key' ) ); ?>" placeholder="e.g., AIzaFyWDzmlFDSRE_gSsFtDsAw3" required />
					...
					<tr valign="top">
						...
						<td>
							<input type="url" name="srb_img_src" value="<?php echo esc_url( srb_get_option( 'srb_img_src' ) ); ?>" placeholder="e.g., https://example.com/Google/logo.svg" required />
					...
					<tr valign="top">
						...
						<td>
							<input type="url" name="srb_review_link" value="<?php echo esc_url( srb_get_option( 'srb_review_link' ) ); ?>" placeholder="e.g., https://maps.app.goo.gl/example" required />
					...
					<tr valign="top">
						...
						<td>
							<input type="number" name="srb_cache_duration" value="<?php echo esc_attr( srb_get_option( 'srb_cache_duration' ) ); ?>" min="60" placeholder="e.g., 3600" />
					...
					<tr valign="top">
						...
						<td>
							<textarea name="srb_schema_description" rows="3" cols="50" placeholder="e.g., Custom web design services by Alpha Labs."><?php echo esc_textarea( srb_get_option( 'srb_schema_description' ) ); ?></textarea>
					...
					<tr valign="top">
						...
						<td>
							<input type="text" name="srb_schema_name" value="<?php echo esc_attr( srb_get_option( 'srb_schema_name' ) ); ?>" placeholder="e.g., Alpha Labs Web Design" />
					...
					<tr valign="top">
						...
						<td>
							<input type="text" name="srb_schema_brand" value="<?php echo esc_attr( srb_get_option( 'srb_schema_brand' ) ); ?>" placeholder="e.g., Alpha Labs" />
					...
					<tr valign="top">
						...
						<td>
							<input type="url" name="srb_schema_id" value="<?php echo esc_url( srb_get_option( 'srb_schema_id' ) ); ?>" placeholder="e.g., https://alphalabs.net/web-design-and-development/" />
					...
					<tr valign="top">
						...
						<td>
							<input type="url" name="srb_schema_url" value="<?php echo esc_url( srb_get_option( 'srb_schema_url' ) ); ?>" placeholder="e.g., https://alphalabs.net/" />
